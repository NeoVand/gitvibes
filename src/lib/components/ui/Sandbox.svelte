...
>
	...
	<!-- Content -->
	<div class="grid grid-cols-1 lg:grid-cols-2" style="min-height: 320px;">
		<!-- Terminal pane -->
		<div class="border-b lg:border-r lg:border-b-0" style="border-color: var(--color-terminal-border);">
			<div
			...
			<div
				...
				style="background: var(--color-terminal-bg); min-height: 280px; max-height: 400px;"
			>
